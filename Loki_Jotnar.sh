...
URLSpoof(){
	...
	clear
echo -e "
${verde}  _           _    _ ${negro}       _ _   _ _
${verde} | |         | |  (_)${negro}      | (_) (_) |
${verde} | |     ___ | | ___ ${negro}      | | ___ | |_ _ __   __ _ _ __ 
${verde} | |    / _ \| |/ / |${negro}  _   | |/ _ \| __| _ \ / __  |    |
${verde} | |___| (_) |   <| |${negro} | |__| | (_) | |_| | | | (_| | | 
${verde} |______\___/|_|\_\_|${negro}  \____/ \___/ \__|_| |_|\__,_|_|   "${blanco}
}
# ===============================================
#                SOLICITANDO URL
# ===============================================
